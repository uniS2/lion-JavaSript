...
receivedEmailAddress = emailAddress ?? 'user@company.io'; // 정의된 값
receivedEmailAddress = emailAddress || 'user@company.io'; // truthy
...
x ||= y;  // x가 false일때 y값을 x에 할당. T||

x &&= y;  // x가 true일때 y값을 x에 할당. F&&
